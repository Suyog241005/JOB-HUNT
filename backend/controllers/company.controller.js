...
export const registerCompany = async (req, res) => {
    try {
        ...
        if (!companyName) {
            return res.status(400).json({ message: "Company's name required", success: false });
        }
...
export const getCompany = async (req, res) => {
    try {
        ...
        return res.status(200).json({ message: "Companies fetched successfully",companies, success: true, companies });
